...
class TestEventSpecifics(unittest.TestCase):
    ...
    def test_find_specifics_empty_collection(self):
        ...
        self.event_specifics._load_collection_contents.assert_called_once_with("non_existent_collection")
    ...
    def test_load_collection_contents(self):
        ...
        mock_collection.get.assert_called_once_with(include=['embeddings', 'documents', 'metadatas'])
