...
class TestRAGPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_loader_patcher = patch('pipeline.ConfigLoader')
        self.embedding_processor_patcher = patch('pipeline.EmbeddingProcessor')
        self.text_processor_patcher = patch('pipeline.TextProcessor')
        self.chroma_manager_patcher = patch('pipeline.ChromaDBManager')
        self.event_specifics_patcher = patch('pipeline.EventSpecifics')
        self.prompt_enricher_patcher = patch('pipeline.PromptEnricher')
    ...
    def test_preprocess_article(self):
        ...
        mock_text_processor_instance.preprocess_article.return_value = ["title", "main text", "literature"]
    ...
    def test_pipeline(self):
        ...
        self.pipeline.process_article = MagicMock(return_value=["article_specific1", "article_specific2"])
