...
from edulytica.common.database.database import SessionLocal
from edulytica.edulytica_api.llms.llm_model import LLM
from celery.signals import celeryd_after_setup

app = Celery('tasks')
app.config_from_object('edulytica.edulytica_api.celery.celeryconfig')
