from src.edulytica_api.schemas.updated_system_schemas import (_UserCreate, _UserUpdate, _UserGet, _TokenCreate,
                                                              _TokenUpdate, _TokenGet, _UserRoleCreate, _UserRoleUpdate,
                                                              _UserRoleGet, _CheckCodeCreate, _CheckCodeUpdate,
                                                              _CheckCodeGet, _TicketCreate, _TicketUpdate, _TicketGet,
                                                              _TicketStatusCreate, _TicketStatusUpdate,
                                                              _TicketStatusGet, _DocumentCreate, _DocumentUpdate,
                                                              _DocumentGet, _DocumentSummaryCreate,
                                                              _DocumentSummaryUpdate, _DocumentSummaryGet,
                                                              _DocumentReportCreate, _DocumentReportUpdate,
                                                              _DocumentReportGet, _EventCreate, _EventUpdate, _EventGet,
                                                              _CustomEventCreate, _CustomEventUpdate, _CustomEventGet)
