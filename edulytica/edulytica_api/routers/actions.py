...
from edulytica.common.auth.auth_bearer import access_token_auth
from edulytica.common.config import ORCHESTRATOR_PORT, RAG_PORT
from edulytica.common.database.crud.document_report_crud import DocumentReportCrud
from edulytica.common.database.crud.document_summary_crud import DocumentSummaryCrud
from edulytica.common.database.crud.event_crud import EventCrud
from edulytica.common.database.crud.custom_event_crud import CustomEventCrud
from edulytica.common.database.crud.document_crud import DocumentCrud
from edulytica.common.database.crud.ticket_status_crud import TicketStatusCrud
from edulytica.common.database.crud.ticket_type_crud import TicketTypeCrud
from edulytica.common.database.crud.tickets_crud import TicketCrud
from edulytica.common.database.database import get_session
from edulytica.common.utils.chroma_utils import is_valid_chroma_collection_name
from edulytica.common.utils.default_enums import TicketStatusDefault, TicketTypeDefault
from edulytica.common.utils.logger import api_logs
from edulytica.edulytica_api.dependencies import get_http_client
from edulytica.edulytica_api.parser.Parser import get_structural_paragraphs, fast_parse_text
