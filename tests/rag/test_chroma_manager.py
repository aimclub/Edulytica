...
class TestChromaDBManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        config_instance.load_config.return_value = {"chromadb": {"host": "localhost", "port": 8000}}
        config_instance.get_host.return_value = "localhost"
        config_instance.get_port.return_value = 8000
        self.mock_config_loader.return_value = config_instance

        # Configure return values for ChromaDB
        mock_chroma_client = MagicMock()
        self.mock_chromadb.HttpClient.return_value = mock_chroma_client
        self.mock_chroma_client = mock_chroma_client

        # Configure return values for embedding processor
        mock_embedding_processor_instance = MagicMock()
        mock_embedding_function = MagicMock()
        mock_embedding_processor_instance.get_embedding_function.return_value = mock_embedding_function
        self.mock_embedding_processor.return_value = mock_embedding_processor_instance
        self.mock_embedding_function = mock_embedding_function

        # Create an instance of ChromaDBManager
    ...
    def test_init(self):
        ...
        self.mock_embedding_processor.assert_called_once()
    ...
    def test_init_with_embedding_processor(self):
        ...
        self.mock_embedding_processor.assert_not_called()
    ...
    def test_add_documents(self):
        ...
        self.chroma_manager.get_collection = MagicMock(return_value=mock_collection)
    ...
    def test_add_documents_collection_not_found(self):
        ...
        self.chroma_manager.get_collection = MagicMock(return_value=None)
    ...
    def test_delete_all_collections(self):
        ...
        self.chroma_manager.list_collections = MagicMock(return_value=[mock_collection1, mock_collection2])
    ...
    def test_delete_all_collections_no_collections(self):
        ...
        self.chroma_manager.list_collections = MagicMock(return_value=[])
