...
from edulytica.common.config import KAFKA_BOOTSTRAP_SERVERS, ORCHESTRATOR_PORT
from edulytica.orchestration.clients.kafka_consumer import KafkaConsumer
...
from edulytica.orchestration.routers.orchestrator_router import rt
