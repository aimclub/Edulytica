    ...
    def test_correct_answers(self):
        ...
        self.assertEqual(
            text_comparator.count_percent_of_transformed_words(
                "Yesterday I walked my dog for half an hour.", "Thoughts are all charged in favor of the project."
            ),
            100.00,
        )
        self.assertEqual(
            text_comparator.count_percent_of_transformed_words(
                "This guy just walks there.", "I wanna have this ice cream."
            ),
            81.82,
        )
        self.assertEqual(
            text_comparator.count_percent_of_transformed_words(
                "This man is simply beaming with happiness!", "This man is just unbearably happy about it!"
            ),
            60.00,
        )
        self.assertEqual(
